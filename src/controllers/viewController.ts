...
export const getViewCountHandler = async (req: express.Request, res: express.Response) => {
...
export const incrementViewCountHandler = async (req: express.Request, res: express.Response) => {
  const blogId = Number(req.params.id);
